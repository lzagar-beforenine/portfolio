...
type MapTypes<
  ...
  ReplaceObject extends { mapFrom: unknown; mapTo: unknown }
> = {
  [Key in keyof TObject]: TObject[Key] extends ReplaceObject[`mapFrom`]
    ? ReplaceObject extends { mapFrom: TObject[Key]; mapTo: infer ReplaceValue }
      ? ReplaceValue
      : never
    : TObject[Key];
};

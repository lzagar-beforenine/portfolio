...
type StringToUnion<TString extends string> =
...
type Combinations<
  ...
  Iterator = TString
> = Iterator extends TString
  ? Iterator | `${Iterator}${Combinations<Exclude<TString, Iterator>>}`
  : never;

type AllCombinations<TString extends string> = Combinations<
  StringToUnion<TString>
>;
